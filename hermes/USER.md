...
- ~/dotfiles/config/ — hyprland.conf, hypridle.conf, hyprpaper.conf, mako/config

## Desktop
- Hyprland, Waybar, Hyprlauncher (SUPER+R), Hyprlock (SUPER+L), Hypridle, Hyprpaper, Mako, Kitty
